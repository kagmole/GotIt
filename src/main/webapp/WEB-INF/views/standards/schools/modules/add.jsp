...
<l:standard pageTitle="Create a module">
	<sf:form method="POST" commandName="moduleEntity" class="form-horizontal">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-default">Create a module</button>
			</div>
		</div>
	</sf:form>
</l:standard>
